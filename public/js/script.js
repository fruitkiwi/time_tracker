...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskTable = _react2.default.createClass({
	  genId: function genId() {
	    return 'id' + this.count++;
	  },
	  findTaskIndex: function findTaskIndex(id) {
	    return this.state.tasks.findIndex(function (element) {
	      return element.id === id;
	    });
	  },
	  handleAdd: function handleAdd() {
	    var task = arguments.length <= 0 || arguments[0] === undefined ? { taskName: '', taskBid: 0 } : arguments[0];
	  ...
	  handleDelete: function handleDelete(task) {
	    var id = task.id;
	  ...
	  handleChange: function handleChange(task) {
	    var id = task.id;
	    var index = this.findTaskIndex(id);
	    if (index === -1) {
	    ...
	    if (typeof task.taskBid === 'number') newtask.taskTotal.price = (newtask.taskTotal.time * fromHoursRate(task.taskBid)).toFixed(2);else if (typeof task.taskTrack === 'number') {
	  ...
	  componentDidUpdate: function componentDidUpdate() {
	    if (this.state.tasks.length != 0) localStorage.setItem(this.props.storage, JSON.stringify(this.state.tasks));else localStorage.removeItem(this.props.storage);
	  },
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: 'task-table' },
	      _react2.default.createElement(TaskAdd, { onadd: this.handleAdd }),
	      _react2.default.createElement(TaskList, { tasks: this.state.tasks, ondelete: this.handleDelete, onchange: this.handleChange })
	    );
	  }
	});

	var TaskAdd = _react2.default.createClass({
	  handleClick: function handleClick(e) {
	    var target = e.target;
	    if (target === this.refs.newtask) {
	      var name = this.refs.taskname.value.trim();
	      var bid = this.refs.taskbid.value.trim();
	    ...
	    } else if (target === this.refs.emptytask) this.props.onadd();
	  },
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: 'task-table__add' },
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__add__column task-table__add__column--first' },
	        _react2.default.createElement(
	          'label',
	          { htmlFor: 'taskname' },
	          'Task name'
	        ),
	        _react2.default.createElement('input', { type: 'text', id: 'taskname', placeholder: 'Task name', maxLength: '300', className: 'text-input', ref: 'taskname' })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__add__column task-table__add__column--second' },
	        _react2.default.createElement(
	          'label',
	          { htmlFor: 'taskbid' },
	          'Task bid'
	        ),
	        _react2.default.createElement('input', { type: 'text', id: 'taskbid', placeholder: 'Task bid', maxLength: '15', className: 'text-input', ref: 'taskbid' })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__add__column task-table__add__column--third' },
	        _react2.default.createElement('input', { type: 'button', value: 'Create task', className: 'button', onClick: this.handleClick, ref: 'newtask' })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__add__column task-table__add__column--forth' },
	        'OR'
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__add__column task-table__add__column--fifth' },
	        _react2.default.createElement(
	          'span',
	          { className: 'action-link', onClick: this.handleClick, ref: 'emptytask' },
	          'Add empty task'
	        )
	      )
	    );
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      this.props.tasks.map(function (task) {
	        return _react2.default.createElement(Task, { data: task, ondelete: this.props.ondelete, onchange: this.props.onchange, key: task.id });
	      }, this)
	    );
	  }
	});
	...
	var Task = _react2.default.createClass({
	  ...
	  handleChange: function handleChange(e) {
	    ...
	    switch (mode) {
	      ...
	      case 2:
	        ...
	        var bid = this.refs.bidinput.value.trim();
	        if (name !== '' && isNumber(bid)) {
	          this.props.onchange({
	        ...
	        } else console.log('wrong name/bid args input in task edit');
	        break;
	    }
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    if (typeof this.props.data.taskTrack !== 'undefined') state.ticked = this.props.data.taskTrack;else state.ticked = 0;
	    return state;
	  },
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'task-table__task' },
	      _react2.default.createElement('div', { className: 'task-table__task__remove', onClick: this.handleDelete }),
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__task__column task-table__task__column--first' },
	        mode === 2 ? _react2.default.createElement('input', { type: 'text', defaultValue: this.props.data.taskName, className: 'text-input', ref: 'nameinput' }) : _react2.default.createElement(
	          'span',
	          { className: 'span-emul' },
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__task__column task-table__task__column--second' },
	        _react2.default.createElement(
	          'div',
	          { className: "task-table__task__timer " + (this.state.mode === 1 ? "task-table__task__timer--pause" : "task-table__task__timer--play"), onClick: this.handleAction },
	          formatTime(this.state.ticked ? this.state.ticked : 0)
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__task__column task-table__task__column--third' },
	        mode === 2 ? _react2.default.createElement('input', { type: 'text', defaultValue: this.props.data.taskBid, className: 'text-input', ref: 'bidinput' }) : _react2.default.createElement(
	          'span',
	          { className: 'span-emul' },
	          this.props.data.taskBid
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'task-table__task__column task-table__task__column--forth' },
	        _react2.default.createElement(
	          'div',
	          { className: 'task-table__task__total-time' },
	          formatTime(this.props.data.taskTotal.time)
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'task-table__task__total-price' },
	          this.props.data.taskTotal.price
	        )
	      ),
	      _react2.default.createElement('div', { className: 'task-table__task__edit', onClick: this.handleChange })
	    );
	  }
	});

	(0, _reactDom.render)(_react2.default.createElement(TaskTable, { storage: 'tasktable' }), document.getElementById('wrapper'));
